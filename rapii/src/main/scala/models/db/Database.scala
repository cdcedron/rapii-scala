...
object Database {
  ...
  private[models] val consumers = new DatabaseTable[Consumers]("consumers.json")
  private[models] val providers = new DatabaseTable[Providers]("providers.json")
  ...
  private val databases = List(
    (locations, Location), (consumers, Consumers), (providers, Providers),
